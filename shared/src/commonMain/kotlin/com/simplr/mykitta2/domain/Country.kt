...
enum class Country(val iso: String, val wireFormat: String, val dialCode: String, val flagEmoji: String) {
    PH(iso = "PH", wireFormat = "PHILIPPINE", dialCode = "+63", flagEmoji = "🇵🇭"),
    SG(iso = "SG", wireFormat = "SINGAPORE", dialCode = "+65", flagEmoji = "🇸🇬");
